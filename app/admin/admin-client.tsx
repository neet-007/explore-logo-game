...
import { addAdminUserAction, addQuestionAction, revalidateCacheAction, verifyAdminAction } from "@/app/actions/game-actions";
...
export default function AdminClient() {
  ...
  async function loginAdmin() {
    ...
    try {
      const result = await verifyAdminAction({ username: adminUsername, password: adminPassword });
      if (!result.ok) {
    ...
    <main style={{ maxWidth: "900px", margin: "0 auto", padding: "16px" }}>
      ...
      <section style={{ border: "1px solid #2a2a2a", borderRadius: "8px", padding: "16px", backgroundColor: "#111111", marginBottom: "12px" }}>
        ...
        <p style={{ color: "#d4d4d8", marginBottom: "8px" }}>
          First admin must be inserted directly into DB. After that, only authenticated admins can add more admins.
        </p>
